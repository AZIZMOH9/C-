...
string[] names = { "aziz","ahmed","alex","sara" };
...
static class generate 
{
    public static List<person> generating()
    {
        ...
        persons.Add(new student(23, "aziz", "mohammed",334532,"computer engineering"));
        persons.Add(new student(23, "aziz", "mohammed", 256678, "machine engineering"));
        persons.Add(new student(23, "aziz", "mohammed", 98764, "elicitrical engineering"));
        persons.Add(new student(23, "aziz", "mohammed", 12349, "indisturial engineering"));
